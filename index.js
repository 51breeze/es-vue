...
class PluginEsVue extends Core.Plugin{
    ...
    addGlobUIImports(){
        ...
        const maps={
            ...
            'element-ui/packages/checkbox-button':resolveComponent(this.options,'checkbox/index'),
            'element-ui/packages/radio-group':resolveComponent(this.options,'radio/index'),
            'element-ui/packages/radio-button':resolveComponent(this.options,'radio/index'),
