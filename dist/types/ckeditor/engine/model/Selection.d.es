...
declare class Selection {
     ...
     */
    getAttributes(): Iterator<[string, any]>;
    /**
 ...
 */
declare type Selectable = Selection | DocumentSelection | Position | Range | Node | Iterator<Range> | null;

/**
 * The place or offset of the selection.
 */
declare type PlaceOrOffset = number | 'before' | 'end' | 'after' | 'on' | 'in';
