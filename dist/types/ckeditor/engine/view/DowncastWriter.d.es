package ckeditor.view;

import ckeditor.model.NodeAttributes
import ckeditor.model.Item
import ckeditor.model.PlaceOrOffset
import ckeditor.model.Position
import ckeditor.model.PositionOffset
import ckeditor.model.Text
...
declare class DowncastWriter {
     ...
     * @label NODE_OFFSET
     */
    setSelection(selectable: Node, placeOrOffset: PlaceOrOffset, options?: any): void;
    /**
     * Sets {@link module:engine/view/documentselection~DocumentSelection selection's} ranges and direction to the
     * specified location based on the given {@link module:engine/view/selection~Selectable selectable}.
     *
     ...
     * @label SELECTABLE
     */
    setSelection(selectable:any, options?: any): void;
    /**
     ...
     */
    createDocumentFragment(children?: Node | Iterator<Node>): DocumentFragment;
    /**
     ...
     */
    createAttributeElement(name: string, attributes?: any, options?: {
        priority?: number,
        id?: number | string,
     ...
     * @returns Created element.
     */
    createContainerElement(name: string, attributes?: any, options?: {
        renderUnsafeAttributes?: Array<string>
    }): any;
    /**
     ...
     * @returns Created element.
     */
    createContainerElement(name: string, attributes: any, children: Node | Iterator<Node>, options?: {
        renderUnsafeAttributes?: Array<string>
    }): any;
    /**
     ...
     * @returns Created element.
     */
    createEditableElement(name: string, attributes?: any, options?: {
        renderUnsafeAttributes?: Array<string>
    }): any;
    /**
     ...
     * @returns Created element.
     */
    createEmptyElement(name: string, attributes?: any, options?: {
        renderUnsafeAttributes?: Array<string>
    }): any;
    /**
     ...
     */
    createUIElement(name: string, attributes?: any, renderFunction?: (domDocument: Document, domConverter: any) => Element): any;
    /**
     ...
     * @returns The created element.
     */
    createRawElement(name: string, attributes?: any, renderFunction?: (domElement: Element, domConverter: any) => void, options?: {
        renderUnsafeAttributes?: Array<string>
    }): any;
    /**
     ...
     * @param element Element to set styles on.
     */
    setStyle(property: any, element: Element): void;
    /**
     ...
     */
    setCustomProperty(key:any, value: any, element: Element | DocumentFragment): void;
    /**
     * Removes a custom property stored under the given key.
     *
     * @returns Returns true if property was removed.
     */
    removeCustomProperty(key: any, element: Element | DocumentFragment): boolean;
    /**
     ...
     */
    insert(position: Position, nodes: Node | Iterator<Node>): Range;
    /**
     ...
     */
    wrap(range: Range, attribute: any): Range;
    /**
     ...
     * same parent container.
     */
    unwrap(range: Range, attribute: any): Range;
    /**
     ...
     */
    rename(newName: string, viewElement: any): any;
    /**
     ...
     * @label NODE_OFFSET
     */
    createSelection(selectable: Node, placeOrOffset: any, options?: any): Selection;
    /**
     * Creates new {@link module:engine/view/selection~Selection} instance.
     *
     * ```ts
     ...
     * @label SELECTABLE
     */
    createSelection(selectable?: any, option?: any): Selection;
    /**
     ...
     */
    createSlot(modeOrFilter?:any): Element;
