                        ...
                        if(src){
                            ...
                            if(src){
                                if(src.startsWith('data:image/svg+xml;base64,')){
                                    ...
                                    return [Vue.createStaticVNode(src)];
                                }else if(src.endsWith('.svg') || src.endsWith('.SVG')){
                                    let viewBox = Vue.unref(props.viewBox) || "0 0 24 24";
                                    return [Vue.createStaticVNode(`<svg viewBox="${viewBox}"><use xlink:href="${src}"/></svg>`)];
                                }
