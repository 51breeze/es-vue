...
const excludes = ["patchFlag", "hasMultipleChildNodes","pureStaticAttributes","pureStaticChild","hasConditionDirective"];
        ...
        case 'each' :
            {
                ...
                return createFragmentVNode(ctx, node, null, hasKeys ? ELEMENT_KEYED_FRAGMENT : ELEMENT_UNKEYED_FRAGMENT, false);
            }
    } 
    return null;
}
