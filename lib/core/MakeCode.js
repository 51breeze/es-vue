...
import { callAsyncSequence, getModuleRoutes, getModuleRedirectNode,getPageRoutePath, getModuleAnnotations, createCJSImports, createESMImports} from './Common';
...
class MakeCode extends Token{
    ...
    getModuleRoute(ctx, module){
        return getModuleRoutes(ctx, module);
    }

    makeModuleMetadata(module, compilation){
    ...
    getModuleMetadata(compilation, query={}){
        ...
        if(Utils.isModule(module)){
            return this.makeModuleMetadata(module, compilation)
        }
        return `export default {};`;
    }
