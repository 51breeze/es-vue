...
declare interface EditorConfig {
     ...
     */
    extraPlugins?: Array<PluginConstructor<IEditor>>;
    /**
     ...
     */
    initialData?: string | {[key:string]:string};
    /**
     ...
     */
    plugins?: Array<PluginConstructor<IEditor> | string>;
    /**
 ...
 * editor build}.
     ...
     */
    removePlugins?: Array<PluginConstructor<IEditor> | string>;
    substitutePlugins?: Array<PluginConstructor<IEditor>>;
    /**
...
declare type ToolbarConfig = Array<ToolbarConfigItem> | {
    items?: Array<ToolbarConfigItem>,
    removeItems?: Array<string>,
    shouldNotGroupWhenFull?: boolean
};
declare type ToolbarConfigItem = string | {
    items: Array<ToolbarConfigItem>,
    label: string,
    icon?: string | false,
    withText?: boolean,
    tooltip?: boolean | string | ((label: string, keystroke: string | null) => string)
};
/**
 * The “Powered by CKEditor” logo configuration options.
 **/
declare interface PoweredByConfig {
    /**
 ...
 */
declare interface ViewportOffsetConfig {
    /**
