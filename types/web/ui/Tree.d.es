...
/** Tree Component */
declare final class Tree<K, D extends TreeData> extends Component{
   ...
   */
  renderContent: (h: (tag,data?,children?:[])=>any, context: { node: TreeNode<K, D>, data: D, store: TreeStore<K, D> }) => any;
...
declare interface TreeNode<K, D> {
  checked: boolean;
...
declare interface TreeStore<K, D> {
