...
declare final class Table extends Component {
  ...
  load (row: object, treeNode: TreeItemType, resolve: Function): void
...
declare interface DefaultSortOptions {
  /** Default sort column */
  prop: string,
...
declare interface SummaryMethodParams {
  columns: object[],
  data: object
}

declare interface RowCallbackParams {
  row: object,
  rowIndex: number
}

declare interface CellCallbackParams {
  row: object,
  rowIndex: number,
  column: object,
  columnIndex: number
