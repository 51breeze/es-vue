...
declare internal type SortOrder = 'ascending' | 'descending'

/** Options to set the default sort column and order */
declare internal interface DefaultSortOptions {
  /** Default sort column */
  prop: string,
...
declare internal interface SummaryMethodParams {
  columns: object[],
  data: object
}

declare internal interface rowCallbackParams {
  row: object,
  rowIndex: number
}

declare internal interface cellCallbackParams {
  row: object,
  rowIndex: number,
  column: object,
  columnIndex: number
...
declare internal interface treeNode {
