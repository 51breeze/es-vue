...
declare final class TableColumn extends Component {
  ...
  renderHeader: (h: (tag:Node | Component | string,data?:object,children?:[])=>any, data: RenderHeaderData) => Node | Component | string
...
declare internal interface RenderHeaderData {
...
/** Filter Object */
declare internal interface TableColumnFilter {
