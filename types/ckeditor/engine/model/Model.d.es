...
declare class Model {
     ...
     */
    const markers: MarkerCollection;
    /**
     * Model's document.
     */
     ...
     * @param callback Callback function which may modify the model.
     */
    enqueueChange(callback: (writer: Writer) => any): void;
    /**
     * The `enqueueChange()` method performs similar task as the {@link #change `change()` method}, with two major differences.
     *
     * First, the callback of `enqueueChange()` is executed when all other enqueued changes are done. It might be executed
     ...
     * @param callback Callback function which may modify the model.
     */
    enqueueChange(batchOrType: Batch | BatchType | null, callback: (writer: Writer) => any): void;
    /**
     ...
     */
    insertContent(content: Item | DocumentFragment, selectable?: Selectable, placeOrOffset?: PlaceOrOffset, ...rest): Range;
    /**
     ...
     * at the insertion position.
     */
    insertObject(element: Element, selectable?: Selectable, placeOrOffset?: PlaceOrOffset | null, options?: {
     ...
     */
    deleteContent(selection: Selection | DocumentSelection, options?: {
     ...
     */
    hasContent(rangeOrElement: Range | Element | DocumentFragment, options?: {
     ...
     * @label SELECTABLE
     */
    createSelection(selectable?:any): Selection;
    /**
     ...
     */
    createOperationFromJSON(json: any): Operation;
    /**
