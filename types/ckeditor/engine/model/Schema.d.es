...
declare class Schema {
     ...
     * in other cases.
     */
    getDefinition(item: string | Item | DocumentFragment | SchemaContextItem): SchemaCompiledItemDefinition | null;
    /**
     ...
     */
    getValidRanges(ranges: Iterator<Range>, attribute: string): Iterator<Range>;
    /**
     ...
     */
    setAllowedAttributes(node: Node, attributes: {[key:string]:any}, writer: Writer): void;
    /**
     ...
     */
    getAttributesWithProperty(node: Node, propertyName: string, propertyValue: any):{[key:string]:any};
    /**
 ...
 */
declare interface SchemaItemDefinition {
    /**
 ...
 */
declare interface SchemaCompiledItemDefinition {
    name: string;
    isBlock: boolean;
    isContent: boolean;
    isInline: boolean;
 ...
 */
declare class SchemaContext implements Iterator<SchemaContextItem> {
 ...
 * ```
 */
declare type SchemaContextDefinition = Item | Position | SchemaContext | string | Array<string | Item>;
/**
 ...
 * ```
 */
declare interface SchemaContextItem {
    name: string;
 ...
 */
declare interface AttributeProperties {
    /**
...
declare type SchemaAttributeCheckCallback = (context: SchemaContext, attributeName: string) => any;
declare type SchemaChildCheckCallback = (ctx: SchemaContext, def: SchemaCompiledItemDefinition) => any;
